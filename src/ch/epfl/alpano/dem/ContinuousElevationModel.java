...
public final class ContinuousElevationModel {
    ...
    /**
     * Calculates the elevation of a geopoint by doing a bilinear interpolation of
     * the extent of the dem given to the constructor
     * 
    ...
    public double elevationAt(GeoPoint p) {
        ...
        return bilerp(checkSample(x, y), checkSample(x + 1, y), checkSample(x, y + 1), checkSample(x + 1, y + 1),
                indexLongitude - x, indexLatitude - y);
    }
    ...
    public double slopeAt(GeoPoint p) {
        ...
        return bilerp(doTheta(x, y), doTheta(x + 1, y), doTheta(x, y + 1), doTheta(x + 1, y + 1), indexLongitude - x,
                indexLatitude - y);
    }
    ...
    /**
     * Checks that the index (x, y) is is contained in the dem given to the
     * constructor
     * 
     * @param x index
     * @param y index
