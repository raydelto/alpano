...
public final class PanoramaComputer {
     ...
     * 
     * @param dem the ContinuousElevationModel used to build the PanoramaComputer
     *            (non null)
    ...
    public Panorama computePanorama(PanoramaParameters parameters) {
        ...
        while (posX <= (parameters.width() - 1)) {
            ...
            while (posY >= 0) {
                ...
                DoubleUnaryOperator op = rayToGroundDistance(ep, parameters.observerElevation(),
                        Math.tan(parameters.altitudeForY(posY)));
                double lowerBound = firstIntervalContainingRoot(op, intersectionWithGroundTemp,
                        parameters.maxDistance(), ROOTSTEP);
     ...
     * @return return the DoubleUnaryOperator that represents the function of the
     *         distance from ground of an elevation profile
     */
