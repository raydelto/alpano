...
public final class Panorama {
     ...
     * 
     * @param parameters an array of float where the parameters of the Panorama are
     *                   stored
     * @param distance   an array of float where the distance of the Panorama are
     *                   stored
     * @param longitude  an array of float where the longitude of the Panorama are
     *                   stored
     * @param latitude   an array of float where the latitude of the Panorama are
     *                   stored
     * @param elevation  an array of float where the elevation of the Panorama are
     *                   stored
     * @param slope      an array of float where the slope of the Panorama are
     *                   stored
     */
    ...
    public static final class Builder {
         ...
         * @throws IllegalStateException     if the build() method has already been
         *                                   called for this Builder
         * @throws IndexOutOfBoundsException if the sample is not valid
         * 
         */
         ...
         * @throws IllegalStateException if the build method has already been called on
         *                               the current PanoramaBuider
         */
