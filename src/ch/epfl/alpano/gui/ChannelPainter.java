...
public interface ChannelPainter {
     ...
     * valueAt() for this chanelPainter is the difference of the distance between a
     * given point and the further neighbor of this point
     * 
    ...
    public static ChannelPainter maxDistanceToNeighbors(Panorama p) {
        ...
        return (x, y) -> max(max(p.distanceAt(x - 1, y, 0), p.distanceAt(x, y - 1, 0)),
                max(p.distanceAt(x + 1, y, 0), p.distanceAt(x, y + 1, 0))) - p.distanceAt(x, y, 0);
    }

    /**
     * This method transforms a ChannelPainter in another, it adds a given constant
     * to the result of the method valueAt()
     * 
    ...
    /**
     * This method transforms a ChannelPainter in another, it subtracts a given
     * constant to the result of the method valueAt()
     * 
     * @param c the given constant
     * @return channelPainter with its new definition of the method valueAt()
     */
    ...
    /**
     * This method transforms a ChannelPainter in another, it multiplies by a given
     * constant the result of the method valueAt()
     * 
     * @param c the given constant
     * @return channelPainter with its new definition of the method valueAt()
     */
    ...
    /**
     * This method transforms a ChannelPainter in another, it divides by a given
     * constant the result of the method valueAt()
     * 
     * @param c the given constant
     * @return channelPainter with its new definition of the method valueAt()
    ...
    /**
     * This method transforms a ChannelPainter in another, its new method valueAt()
     * applies a given DoubleUnaryOperator to the previous result of the method
     * valueAt()
     * 
    ...
    /**
     * This method transforms a ChannelPainter in another, its new method valueAt()
     * returns the inverse of the result of the previous method valueAt()
    ...
    /**
     * This method transforms a ChannelPainter in another, the result of the method
     * valueAt() is clamped
     * 
     * @return channelPainter with its new definition of the method valueAt()
     */
    ...
    /**
     * This method transforms a ChannelPainter in another, its new method valueAt()
     * returns the mod 1 of the result of the previous method valueAt()
     * 
     * @return channelPainter with its new definition of the method valueAt()
     */
