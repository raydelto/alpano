...
public class PanoramaParametersBean {
    ...
    /**
     * Private method that synchronizes the parameters entered by the user with the
     * actual parameters of the Panorama
     */
    private void synchronizeParameters() {

        PanoramaUserParameters actualParameters = new PanoramaUserParameters(observerLongitudeProperty().getValue(),
                observerLatitudeProperty().getValue(),
                observerElevationProperty().getValue(), centerAzimuthProperty().getValue(),
                horizontalFieldOfViewProperty().getValue(),
                maxDistanceProperty().getValue(), widthProperty().getValue(), heightProperty().getValue(),
                superSamplingExponentProperty().getValue(), painterProperty().getValue(),
